public final class URL {
    ...
    static final String SIGN_UP_PAGE = BASE + "/poker?command=sign-up-page";
    static final String SIGN_UP_COMMAND = BASE + "/poker?command=sign-up";

    static final String HOME_PAGE = BASE + "/poker?command=home-page";
    static final String PROFILE_PAGE = BASE + "/poker?command=profile-page";
    static final String SETTINGS_PAGE = BASE + "/poker?command=account-settings-page";
    static final String CHANGE_GENERAL_INFO_COMMAND = BASE + "/poker?command=change-general-info";
